...
## Usage
Visit [duration-converter.vercel.app](https://duration-converter.vercel.app/) to access this API <br>
Visit [detailed API documentation here](https://duration-converter.vercel.app/docs) generated with OpenAPI.json <br>
Example: https://duration-converter.vercel.app/convertFromISO?duration=PT5H21M49S responds with [19309000]() which can be processed with HttpRequest in Java, or requests.get in Python.
